        ...
        <div className="container">
          <div className="row">
            <div className="col-md-10 m-auto">
              <br /> <br />
              <Link to="/cours" className="btn btn-warning float-left">
                  Show Cour List
              </Link>
            </div>
            <br />
          ...
          <div className="row">
            <div className="col-md-6">
              <button type="button" className="btn btn-danger  btn-block" onClick={this.onDeleteClick.bind(this,cour._id)}>Delete COUR</button><br />
            </div>

            <div className="col-md-6">
              <Link to={`/edit-cour/${cour._id}`} className="btn btn-info  btn-block">
                    Edit COUR
              </Link>
              <br />
            </div>
